...
return (
     <div className="max-w-5xl mx-auto flex md:items-center md:justify-center h-full p-6"><div>
      ...
      <FormLabel>Job Title</FormLabel>
       <FormControl>
        <Input
            ...
            placeholder="e.g 'Job Graduation Full Stack Web Developer'"
            {...field}
        />
       </FormControl>
       <FormDescription>
        Role Of This Project Offers
       </FormDescription>
       <FormMessage/>
       </FormItem>
        )}

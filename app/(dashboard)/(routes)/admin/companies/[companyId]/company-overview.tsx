  ...
  companyId,
    ...
    const {isSubmitting, isValid} = form.formState;
     ...
     const handlePromptGeneration = async () => {
      try {
        setIsPrompting(true);
        const customPrompt = `Generate an overview content about${rollname}.include information about its history, purpose, features, user base,and impact on the industry, focus on providing a comprehensive yet concise summary suitable readers unfamiliar with the platform.`;
    ...
    const onCopy = () => {
     ...
     return   <div className="mt-6 border bg-neutral-100 rounded-md p-4 ">
                  ...
                  <div className={cn("text-sm mt-2", !initialData.overview && "text-neutral-500 italic")}>
                    {!initialData.overview && "No Company Description"}
                 ...
                 {isPrompting ? (<>
                  ...
                  <Button onClick={handlePromptGeneration}>
                    ...
                    <p className="text-xs text-muted-foreground text-right">Note: Type the company over here to generate the overview content</p>
